...
import 'package:folk/Donor/general.dart';

class SigninDonor extends StatelessWidget {
  @override
    ...
    final loginButon = Material(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => GeneralDonor(),));
        },
        child: Text(
          "Login",
    ...
    final signupButon = Material(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SignunpDonor(),));
        },
        child: Text(
          "Signup",
          style: TextStyle(color: Colors.white, fontSize: 14.0),
